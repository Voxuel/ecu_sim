...
class DiagnosticSessionControlRequest(UDSServiceRequest):
    service_id: int = Field(0x10, description="Service ID for Diagnostic Session Control")
...
class ClearDiagnosticInformationRequest(UDSServiceRequest):
    service_id: int = Field(0x14, description="Service ID for Clear Diagnostic Information")
...
class InputOutputControlByIdentifierRequest(UDSServiceRequest):
    service_id: int = Field(0x2F, description="Service ID for Input Output Control By Identifier")
