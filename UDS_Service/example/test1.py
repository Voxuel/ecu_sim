...
async def send_uds_request():
    ...
    current_session_request = can.Message(arbitration_id=0x7E0, data=[0x22, 0xF1, 0x86, 0x00], is_extended_id=False)
    ...
    change_session_request = can.Message(arbitration_id=0x7E0, data=[0x10, 0x02], is_extended_id=False)
